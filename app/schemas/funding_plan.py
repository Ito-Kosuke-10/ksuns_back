...
class FundingPlanStatusResponse(BaseModel):
    """カードの進捗ステータス"""
    card_id: str
    is_completed: bool
...
class FundingPlanStatusListResponse(BaseModel):
    """全カードの進捗ステータス一覧"""
    statuses: List[FundingPlanStatusResponse]


class FundingPlanChatRequest(BaseModel):
    """チャット送信リクエスト"""
