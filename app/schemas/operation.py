...
class OperationStatusListResponse(BaseModel):
    """全カードの進捗ステータス一覧"""
    statuses: List[OperationStatusResponse]


class OperationChatRequest(BaseModel):
    """チャット送信リクエスト"""
